...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user) {
        ...
        //注册用户
        user.setSalt(CommunityUtil.generateUUID().substring(0, 5));//设置盐
        user.setPassword(CommunityUtil.md5(user.getPassword() + user.getSalt()));//md5加密密码
        //设置用户状态
        user.setType(0);
        user.setStatus(0);
    ...
    public Map<String, Object> login(String username, String password, int expiredSeconds) {
        ...
        long l = System.currentTimeMillis() + expiredSeconds * 1000;
...
//        return userMapper.updateHeader(userId, headerUrl);
     ...
     * @return
     */
    public Map<String, Object> validatePassword(int userId, String password) {
        Map<String, Object> map = new HashMap<>();
        User user = userMapper.selectById(userId);
