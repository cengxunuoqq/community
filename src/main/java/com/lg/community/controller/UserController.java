...
import com.lg.community.annotation.LoginRequired;
import com.lg.community.entity.User;
import com.lg.community.service.FollowService;
import com.lg.community.service.LikeService;
...
public class UserController implements CommunityConstant {
    ...
    public String updatePassword(String oldPassword, String newPassword, String repeatPassword, @CookieValue("ticket")String ticket, Model model) {
        ...
        User user = hostHolder.getUser();
        Map<String, Object> map = userService.validatePassword(user.getId(), oldPassword);
        if (!map.isEmpty()) {
